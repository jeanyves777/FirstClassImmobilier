...
const NAV = [
  ...
  { href: '/admin/testimonials', key: 'navTestimonials', icon: IconStar },
...
function IconStar(p: { className?: string }) { return <svg {...svgProps(p.className)}><path d="m12 2 3.1 6.3 7 .9-5 4.9 1.2 6.9L12 17.7l-6.3 3.3 1.2-6.9L2 9.2l7-.9z"/></svg> }
